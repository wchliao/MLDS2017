...
def params_setup(cmdline=None):
  ...
  parser.add_argument('--vocab_size', type=int, default=80000, help='Dialog vocabulary size.') #100000
  parser.add_argument('--size', type=int, default=128, help='Size of each model layer.') #256
  ...
  parser.add_argument('--n_bonus', type=float, default=0.1, help='bonus with sentence length')

  # environment params
  parser.add_argument('--gpu_usage', type=float, default=1, help='tensorflow gpu memory fraction used')
  parser.add_argument('--rev_model', type=int, default=1, help='reverse Q-A pair, for bi-direction model')
