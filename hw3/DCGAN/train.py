...
def main():
	...
	parser.add_argument('--data_set', type=str, default="faces",
                       help='Dat set: MS-COCO, flowers, faces')
	...
	for i in range(args.epochs):
		...
		while batch_no*args.batch_size < loaded_data['data_length']:
			...
			print str('> d1:{}, d2:{}, d3:{}, D:{}').format(d1,d2,d3,d_loss)
			# print "d1", d1
			# print "d2", d2
			# print "d3", d3
			# print "D", d_loss
			...
			print str('> ({})batch {}/{}: dloss:{}, gloss:{}').format(i+1,batch_no*args.batch_size, len(loaded_data['image_list']), d_loss, g_loss)
...
def load_training_data(data_dir, data_set):
	if data_set == 'flowers':
		...
		# print 'loaded img:'
		# for z in range(10):
		# 	print image_list[z],faces_captions[image_list[z]]
...
def get_training_batch(batch_no, batch_size, image_size, z_dim, 
	...
	if data_set == 'faces':
		...
		for i in range(batch_no * batch_size, batch_no * batch_size + batch_size):
			...
			random_caption = random.randint(0,len(loaded_data['captions'][loaded_data['image_list'][idx]])-1)
			# print loaded_data['image_list'][idx]
