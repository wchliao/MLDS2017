...
def main():
	...
	parser.add_argument('--model_path', type=str, default='Data/Models/small3_model_after_faces_epoch_300.ckpt',
	...
	for cn, caption_vector in enumerate(caption_vectors):
		...
		caption_images = []
		z_noise = np.random.uniform(-5, 5, [args.n_images, args.z_dim])
