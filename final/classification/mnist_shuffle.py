...
def plotResults(results):
    ...
    fig.savefig('mnist_shuffle_accuracy.png')
    ...
    handles, labels = ax.get_legend_handles_labels()
    ax.legend(handles, labels)
    fig.savefig('mnist_shuffle_val_accuracy.png')
    ...
    handles, labels = ax.get_legend_handles_labels()
    ax.legend(handles, labels)
    fig.savefig('mnist_shuffle_ce.png')
...
def main():
    ...
    for batch_size in [1]:
        ...
        nn.save_weights("mnist_shuffle" + "b" + str(batch_size) + ".h5")
